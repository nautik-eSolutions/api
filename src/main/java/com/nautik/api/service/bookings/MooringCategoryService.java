...
public class MooringCategoryService {
    ...
    public List<MooringCategoryDto> getPriceConfigurations(Integer portId){
        ...
        return mooringCategories.stream().map(mc->modelMapper.map(mc, MooringCategoryDto.class)).toList();
    }
